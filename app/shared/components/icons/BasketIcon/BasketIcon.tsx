...
const BasketIcon: React.FC<IconProps> = ({ color = "primary", className, ...props }) => {
    return (
        <svg className={classNames(styles.icon, className, styles[color])} {...props} width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
